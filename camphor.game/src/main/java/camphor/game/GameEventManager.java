...
public final class GameEventManager {
     ...
     */
    private class PendingListener {
        String eventId;
        GameEventListener listener;
        boolean register;

        PendingListener(String eventId, GameEventListener listener, boolean register) {
    ...
    public boolean hasRegistered(String eventId, GameEventListener listener) {
        ...
        return registered != null && registered.contains(listener);
    }
