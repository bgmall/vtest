...
import servicefactories.BasicService;
...
public class BasicServiceVertxProxyHandler extends ProxyHandler {
  ...
  public BasicServiceVertxProxyHandler(Vertx vertx, BasicService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public BasicServiceVertxProxyHandler(Vertx vertx, BasicService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public BasicServiceVertxProxyHandler(Vertx vertx, BasicService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
