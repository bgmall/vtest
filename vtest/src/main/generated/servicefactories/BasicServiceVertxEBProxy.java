...
public class BasicServiceVertxEBProxy implements BasicService {
  ...
  public BasicServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public BasicServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
